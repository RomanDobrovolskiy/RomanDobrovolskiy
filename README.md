...
Backend важная составляющая любого приложения, хоть она и скрыта от глаз пользователей. Мне всегда было интересно, "а что там под оберткой?". Пишу код, изучаю игровые механики, стремлюсь сделать пользователей максимально счастливыми😉 (иногда и сам сталкиваюсь с багами как пользователь и пытаюсь намекать разработчикам через BugReports 😂).

Разработанные проекты: 
<br>- [Filmorate](https://github.com/RomanDobrovolskiy/java-filmorate-group) - REST приложение для работы с базой 
